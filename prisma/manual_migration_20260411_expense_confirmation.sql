-- SplitWISER manual migration for expense confirmation/history workflow
-- Apply on PostgreSQL before deploying updated server code.
...
CREATE INDEX IF NOT EXISTS expense_confirmations_userId_idx
  ON expense_confirmations ("userId");
...
CREATE INDEX IF NOT EXISTS expense_history_expenseId_createdAt_idx
  ON expense_history ("expenseId", "createdAt");
